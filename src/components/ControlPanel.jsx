  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <a
          href="https://www.instagram.com/sayan_2713/"
          target="_blank"
        ...
        <a
          href="https://github.com/Sayan2713"
          target="_blank"
          rel="noopener noreferrer"
          style={{
            color: 'rgba(255, 255, 255, 0.6)',
        ...
        }}><a href="https://www.sayankrmondal.in" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>
          @Sayan_2713
          </a>
        </span>
      </div>
